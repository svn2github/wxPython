...
class ShadowFilter(object):
    def __init__(self, sigma, kernel_size, offset, surface_size, shadow_colour = (0,0,0,255), method = 'fftreal'):
        self.sigma = sigma
    ...
    def render( self, renderer, camera, renderChildren ):
        ...
        self.bitmap_view = renderBitmap( blurred_image, self.surface_renderer.camera, camera, renderer, self.offset )
