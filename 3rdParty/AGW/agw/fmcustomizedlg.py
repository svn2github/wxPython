...
:class:`~flatmenu.FlatMenu` on the fly, allowing also the user of your application to do the same.
"""
...
class FMTitlePanel(wx.Panel):
    ...
    def __init__(self, parent, title):
        ...
        :param `parent`: the :class:`~fmcustomizedlg.FMTitlePanel` parent;
    ...
    def OnEraseBackground(self, event):
        """
        Handles the ``wx.EVT_ERASE_BACKGROUND`` event for :class:`~fmcustomizedlg.FMTitlePanel`.
    ...
    def OnPaint(self, event):
        """
        Handles the ``wx.EVT_PAINT`` event for :class:`~fmcustomizedlg.FMTitlePanel`.
...
class FMCustomizeDlg(wx.Dialog):
    """
    Class used to customize the appearance of :class:`~flatmenu.FlatMenu` and :class:`~flatmenu.FlatMenuBar`.
    """
    ...
    def __init__(self, parent=None):
        ...
        :param `parent`: the :class:`~fmcustomizedlg.FMCustomizeDlg` parent window.
        """
    ...
    def Initialise(self):
        """ Initialzes the :class:`~labelbook.LabelBook` pages. """
    ...
    def CreateMenusPage(self):
        """ Creates the :class:`~labelbook.LabelBook` pages with :class:`~flatmenu.FlatMenu` information. """
    ...
    def CreateShortcutsPage(self):
        """ Creates the :class:`~labelbook.LabelBook` shorcuts page. """
    ...
    def CreateOptionsPage(self):
        """ Creates the :class:`~labelbook.LabelBook` option page which holds the :class:`~flatmenu.FlatMenu` styles. """
    ...
    def OnMenuChecked(self, event):
        """
        Handles the ``wx.EVT_CHECKBOX`` event for :class:`~fmcustomizedlg.FMCustomizeDlg`.

        :param `event`: a `wx.CommandEvent` event to be processed.

        :note: This method handles the :class:`~flatmenu.FlatMenu` menus visibility.
        """
    ...
    def OnChangeStyle(self, event):
        ...
        :note: This method handles the :class:`~flatmenu.FlatMenu` styles.        
        """
