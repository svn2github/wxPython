...
Call :meth:`SwitcherItems.AddItem() <SwitcherItems.AddItem>` and optionally :meth:`SwitcherItems.AddGroup() <SwitcherItems.AddGroup>` to add items and headings. These
...
whose modifier matches the one you pass to :meth:`SwitcherDialog.SetModifierKey() <SwitcherDialog.SetModifierKey>` 
...
class SwitcherDialog(wx.Dialog):
    """
    SwitcherDialog shows a :class:`Dialog` with a list of panes
