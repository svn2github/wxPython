...
"""
:class:`~floatspin.FloatSpin` implements a floating point `wx.SpinCtrl`.


Description
===========

:class:`~floatspin.FloatSpin` implements a floating point `wx.SpinCtrl`. It is built using a custom
...
floating point representations, :class:`~floatspin.FloatSpin` uses the great :class:`~floatspin.FixedPoint` class
from Tim Peters.
...
- Set minimum, maximum values for :class:`~floatspin.FloatSpin` as well as its range;
...
:class:`~floatspin.FloatSpin` catches 3 different types of events:
...
2) Char events: playing with up/down arrows of the keyboard increase/decrease
   the value of :class:`~floatspin.FloatSpin`;
3) Mouse wheel event: using the wheel will change the value of :class:`~floatspin.FloatSpin`.
...
- Combinations of ``Shift``, ``Ctrl``, ``Alt`` increment the :class:`~floatspin.FloatSpin` value by the
...
=============== =========== ==================================================
``FS_READONLY``         0x1 Sets :class:`~floatspin.FloatSpin` as read-only control.
...
================= ==================================================
``EVT_FLOATSPIN`` Emitted when the user changes the value of :class:`~floatspin.FloatSpin`, either with the mouse or with the keyboard.
================= ==================================================
...
:class:`~floatspin.FloatSpin` control is distributed under the wxPython license.
...
FS_READONLY = 1
""" Sets :class:`~floatspin.FloatSpin` as read-only control. """
FS_LEFT = 2
...
""" Emitted when the user changes the value of :class:`~floatspin.FloatSpin`, either with the mouse or""" \
""" with the keyboard. """
...
class FloatTextCtrl(wx.TextCtrl):
    ...
    def __init__(self, parent, id=wx.ID_ANY, value="", pos=wx.DefaultPosition,
        ...
        :param `parent`: the :class:`~floatspin.FloatTextCtrl` parent;
    ...
    def OnDestroy(self, event):
        """
        Handles the ``wx.EVT_WINDOW_DESTROY`` event for :class:`~floatspin.FloatTextCtrl`.
    ...
    def OnChar(self, event):
        """
        Handles the ``wx.EVT_CHAR`` event for :class:`~floatspin.FloatTextCtrl`.
    ...
    def OnKillFocus(self, event):
        """
        Handles the ``wx.EVT_KILL_FOCUS`` event for :class:`~floatspin.FloatTextCtrl`.
...
class FloatSpin(wx.PyControl):
    ...
    def __init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition,
        ...
        :param `parent`: the :class:`~floatspin.FloatSpin` parent;
        :param `id`: an identifier for the control: a value of -1 is taken to mean a default;
        :param `pos`: the control position. A value of (-1, -1) indicates a default position,
         chosen by either the windowing system or wxPython, depending on platform;
        :param `size`: the control size. A value of (-1, -1) indicates a default size,
         chosen by either the windowing system or wxPython, depending on platform;
        :param `style`: the window style;
        :param `value`: is the current value for :class:`~floatspin.FloatSpin`;
        :param `min_val`: the minimum value, ignored if ``None``;
        :param `max_val`: the maximum value, ignored if ``None``;
        :param `increment`: the increment for every :class:`~floatspin.FloatSpinEvent` event;
    ...
    def OnDestroy(self, event):
        """
        Handles the ``wx.EVT_WINDOW_DESTROY`` event for :class:`~floatspin.FloatSpin`.
    ...
    def OnSpinMouseDown(self, event):
        """
        Handles the ``wx.EVT_LEFT_DOWN`` event for :class:`~floatspin.FloatSpin`.
    ...
    def OnSpinUp(self, event):
        """
        Handles the ``wx.EVT_SPIN_UP`` event for :class:`~floatspin.FloatSpin`.
    ...
    def OnSpinDown(self, event):
        """
        Handles the ``wx.EVT_SPIN_DOWN`` event for :class:`~floatspin.FloatSpin`.
    ...
    def OnTextEnter(self, event):
        """
        Handles the ``wx.EVT_TEXT_ENTER`` event for :class:`~floatspin.FloatSpin`.
    ...
    def OnChar(self, event):
        """
        Handles the ``wx.EVT_CHAR`` event for :class:`~floatspin.FloatSpin`.
    ...
    def OnMouseWheel(self, event):
        """
        Handles the ``wx.EVT_MOUSEWHEEL`` event for :class:`~floatspin.FloatSpin`.
    ...
    def OnSize(self, event):
        """
        Handles the ``wx.EVT_SIZE`` event for :class:`~floatspin.FloatSpin`.
    ...
    def SetValue(self, value):
        """
        Sets the :class:`~floatspin.FloatSpin` value.
    ...
    def GetValue(self):
        """ Returns the :class:`~floatspin.FloatSpin` value. """
    ...
    def SetRangeDontClampValue(self, min_val, max_val):
        ...
        :param `min_val`: the minimum value for :class:`~floatspin.FloatSpin`. If it is ``None`` it is
         ignored;
        :param `max_val`: the maximum value for :class:`~floatspin.FloatSpin`. If it is ``None`` it is
         ignored.
    ...
    def SetIncrement(self, increment):
        ...
        :param `increment`: a floating point number specifying the :class:`~floatspin.FloatSpin` increment.
        """
    ...
    def SetDigits(self, digits=-1):
        ...
        :param `digits`: the number of digits to show. If `digits` < 0, :class:`~floatspin.FloatSpin`
    ...
    def GetFormat(self):
        ...
        :see: :meth:`~floatspin.FloatSpin.SetFormat` for a list of valid string formats.
        """
    ...
    def SetDefaultValue(self, defaultvalue):
        """
        Sets the :class:`~floatspin.FloatSpin` default value.

        :param `defaultvalue`: a floating point value representing the new default
         value for :class:`~floatspin.FloatSpin`.
        """
    ...
    def GetDefaultValue(self):
        """ Returns the :class:`~floatspin.FloatSpin` default value. """
    ...
    def SetToDefaultValue(self):
        """ Sets :class:`~floatspin.FloatSpin` value to its default value. """
    ...
    def OnFocus(self, event):
        """
        Handles the ``wx.EVT_SET_FOCUS`` event for :class:`~floatspin.FloatSpin`.
    ...
    def OnKillFocus(self, event):
        """
        Handles the ``wx.EVT_KILL_FOCUS`` event for :class:`~floatspin.FloatSpin`.
    ...
    def GetMin(self):
        """
        Returns the minimum value for :class:`~floatspin.FloatSpin`. It can be a
    ...
    def GetMax(self):
        """
        Returns the maximum value for :class:`~floatspin.FloatSpin`. It can be a
        number or ``None`` if no minimum is present.
        """
    ...
    def HasRange(self):
        """ Returns whether :class:`~floatspin.FloatSpin` range has been set or not. """
    ...
    def InRange(self, value):
        """
        Returns whether a value is inside :class:`~floatspin.FloatSpin` range.
...
class FixedPoint(object):
    ...
    Note that if the precision of a FixedPoint is reduced via :meth:`FixedPoint.set_precision() <floatspin.FixedPoint.set_precision>`,
    ...
    When :class:`~floatspin.FixedPoint` objects of different precision are combined via + - * /,
    the result is computed to the larger of the inputs' precisions, which also
    becomes the precision of the resulting :class:`~floatspin.FixedPoint` object. Example::
    ...
    When a :class:`~floatspin.FixedPoint` is combined with other numeric types (ints, floats,
    strings representing a number) via + - * /, then similarly the computation
    is carried out using -- and the result inherits -- the :class:`~floatspin.FixedPoint`'s
    precision. Example::
    ...
    The :class:`~floatspin.FixedPoint` constructor can be passed an int, long, string, float,
    :class:`~floatspin.FixedPoint`, or any object convertible to a float via `float()` or to a
    ...
    Note that conversion of floats to :class:`~floatspin.FixedPoint` can be surprising, and
    ...
    def get_precision(self):
        """
        Return the precision of this :class:`~floatspin.FixedPoint`.
    ...
    def set_precision(self, precision=DEFAULT_PRECISION):
        """
        Change the precision carried by this :class:`~floatspin.FixedPoint` to `precision`.

        :param `precision`: must be an int >= 0, and defaults to
         ``DEFAULT_PRECISION``.

        :note: If `precision` is less than this :class:`~floatspin.FixedPoint`'s current precision,
         information may be lost to rounding.
        """
    ...
    def copy(self):
        """ Create a copy of the current :class:`~floatspin.FixedPoint`. """
    ...
    def frac(self):
        """
        Returns fractional portion as a :class:`~floatspin.FixedPoint`.

        :note: In :class:`~floatspin.FixedPoint`,
